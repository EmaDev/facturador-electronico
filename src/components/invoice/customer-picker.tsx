...
const CustomerPicker = React.forwardRef<CustomerPickerHandle, Props>(
  ({ value,
    onChange,
    autoLoad = true,
    initialCustomers = [],
    ...
    React.useImperativeHandle(ref, () => ({
      reset: () => {
        setSearch("");             // borra input búsqueda
        setClosedBySelect(false);  // reabre cuando escriba otra vez
        onChange(null);            // limpia cliente seleccionado
      }
    }));
    return (
